...
public class ForConditionStmt extends Statement {
    ...
    public ForConditionStmt (ForLoopStart ForLoopStart, ForStatement ForStatement, FirstForSemicolon FirstForSemicolon, CondFact CondFact, SecondForSemicolon SecondForSemicolon, FinalForStatement FinalForStatement, Statement Statement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ForConditionStmt(\n");
